  ...
  return (
    <AdminSection title="AI Profile Wizard">
      <p className="text-text-secondary text-sm mb-4">
        Describe yourself, your career, and your accomplishments in the text box below. Our AI will analyze your
        description and automatically generate a complete profile for you. The more detail you provide, the better the
        result!
      </p>
      <div className="bg-yellow-100 dark:bg-yellow-900/30 border-l-4 border-yellow-500 text-yellow-800 dark:text-yellow-200 p-4 rounded-md text-sm mb-6">
        <p>
          <strong>Warning:</strong> Using "Generate Profile" will overwrite existing data in all profile sections
          (Personal Info, Experience, etc.). AI-generated content may require review and refinement. Please back up your
          current data using the Export feature in the Display tab if you wish to save it.
        </p>
      </div>
        ...
        <button
          ...
          title={
            !data.personalInfo.name || !data.personalInfo.title
              ? 'Generate profile or add name/title first'
              : 'Suggest placeholder images'
          }
        >
          {isGeneratingImages ? (
            <>
