        ...
        {(['frontend', 'backend', 'tools'] as const).map((category) => (
          <div key={category} className="mb-8">
            ...
            {data.skills[category].map((skill, index) => (
              ...
              >
                ...
                <InputField
                  ...
                  name="name"
                  value={skill.name}
                  onChange={(e) => handleSkillChange(category, index, e)}
                  onBlur={(e) => handleBlur(category, index, e)}
                  placeholder="e.g., React"
                  error={errors[category]?.[index]?.name}
                />
                <InputField
                  ...
                  value={skill.icon || ''}
                  onChange={(e) => handleSkillChange(category, index, e)}
                  placeholder="e.g., react, vue, nodejs"
                />
                ...
                />
                <button
                  onClick={() => handleRemoveClick(category, index)}
                  className="text-red-500 hover:text-red-700 text-sm mt-4 flex items-center gap-1"
                >
            ...
            <button
              ...
              className="bg-secondary/20 text-secondary px-3 py-1 text-sm rounded-md mt-2"
            >
              Add {category} skill
            </button>
          </div>
