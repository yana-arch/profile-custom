...
// @ts-ignore React class component type issues
        ...
        this.props.fallback || (
          <div className="min-h-screen flex items-center justify-center bg-background">
            <div className="max-w-md mx-auto text-center p-6">
              ...
              <h1 className="text-lg font-medium text-text-primary mb-2">Đã xảy ra lỗi không mong muốn</h1>
              <p className="text-text-secondary mb-4">Ứng dụng gặp sự cố. Vui lòng thử lại hoặc tải lại trang.</p>
