...
import { UserIcon, CogIcon, DocumentArrowDownIcon, Bars3Icon } from '../../../components/icons/Icons';
...
export const UserMenu: React.FC<UserMenuProps> = ({ onProfileCreate, onProfileManage }) => {
      ...
      <div className="relative">
        ...
        >
          {authState.user.user_metadata?.avatar_url ? (
            <img src={authState.user.user_metadata.avatar_url} alt="Avatar" className="h-8 w-8 rounded-full" />
          ) : (
          ...
          <div className="hidden md:block text-left">
            ...
            <div className="text-xs text-text-secondary">{authState.user.email}</div>
          </div>
        </button>
