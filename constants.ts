  ...
  experience: [
    {
      ...
      endDate: 'Present',
      description:
        '<ul><li>Led the development of a new microservices-based architecture, improving system scalability by 50%.</li><li>Mentored junior developers and conducted code reviews to ensure code quality and consistency.</li></ul>',
    ...
    },
    {
      ...
      endDate: 'Dec 2019',
      description:
        '<p>Developed and maintained client-facing web applications using Angular and .NET Core. Collaborated with cross-functional teams to deliver high-quality software solutions.</p>',
  ...
  education: [
    {
      ...
      endDate: '2017',
      description:
        '<p>Graduated with honors. Active member of the coding club and participated in several hackathons.</p>',
    },
  ],
  projects: [
    {
      ...
      description:
        '<p>A full-featured e-commerce platform with a React-based frontend and a Node.js backend. Implemented features like product search, shopping cart, and Stripe integration for payments.</p>',
    ...
    },
    {
      ...
      description:
        '<p>A Kanban-style project management tool built with Vue.js and Firebase. Allows users to create boards, lists, and cards to manage their tasks and workflows.</p>',
