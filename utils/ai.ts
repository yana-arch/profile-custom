      ...
      items: {
        ...
        properties: {
          ...
          description: {
            type: Type.STRING,
            description:
              'A description of responsibilities and achievements, formatted with simple HTML tags like <p>, <ul>, and <li>.',
          },
...
export async function generateProfileFromDescription(
  settings: AiSettings,
  description: string
